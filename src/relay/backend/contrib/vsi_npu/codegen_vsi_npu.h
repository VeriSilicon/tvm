...
public:
  VsiErrorReporter(const IRModule &module, const GlobalVar &var)
...
public:
  TensorMakerImpl(const IRModule &module, const GlobalVar &var)
      : VsiErrorReporter(module, var) {}
...
std::map<Expr, std::shared_ptr<OpSetup>> MakeTensor(const IRModule &module, const GlobalVar &var, const Expr &expr) {
...
public:
  GraphMakerImpl(const IRModule &module, const GlobalVar &var)
      : VsiErrorReporter(module, var) {}
...
RawGraphDef MakeGraph(const IRModule &module, const GlobalVar &var,
                      const Function &func) {
